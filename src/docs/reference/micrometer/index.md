...
```groovy
implementation group: "org.http4k", name: "http4k-metrics-micrometer", version: "4.9.0.2"
```
...
### Micrometer [<img class="octocat"/>](https://github.com/http4k/http4k/blob/master/src/docs/reference/metrics/example_micrometer.kt)
...
<script src="https://gist-it.appspot.com/https://github.com/http4k/http4k/blob/master/src/docs/reference/micrometer/example.kt"></script>
