...
```groovy
implementation group: "org.http4k", name: "http4k-contract", version: "4.9.0.2"
implementation group: "org.http4k", name: "http4k-format-<insert json lib>", version: "4.9.0.2"
```
