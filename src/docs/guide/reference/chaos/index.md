...
```groovy
implementation group: "org.http4k", name: "http4k-testing-chaos", version: "4.9.0.2"
```
...
#### Code [<img class="octocat"/>](https://github.com/http4k/http4k/blob/master/src/docs/reference/chaos/example_chaos.kt)

<script src="https://gist-it.appspot.com/https://github.com/http4k/http4k/blob/master/src/docs/reference/chaos/example_chaos.kt"></script>
...
#### Code [<img class="octocat"/>](https://github.com/http4k/http4k/blob/master/src/docs/reference/chaos/example_chaos_controls_openapi.kt)

<script src="https://gist-it.appspot.com/https://github.com/http4k/http4k/blob/master/src/docs/reference/chaos/example_chaos_controls_openapi.kt"></script>

### Interacting with ChaosEngine using an HTTP client

#### Code [<img class="octocat"/>](https://github.com/http4k/http4k/blob/master/src/docs/reference/chaos/example_chaos_controls_client.kt)

<script src="https://gist-it.appspot.com/https://github.com/http4k/http4k/blob/master/src/docs/reference/chaos/example_chaos_controls_client.kt"></script>
